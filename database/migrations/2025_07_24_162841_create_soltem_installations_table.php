...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('soltem_installations', function (Blueprint $table) {
            ...
            $table->foreignId('employee_id')->constrained()->onDelete('cascade');   // yang melakukan instalasi
            $table->foreignId('soltem_id')->constrained()->onDelete('cascade');     // soltem yang diinstalasi
